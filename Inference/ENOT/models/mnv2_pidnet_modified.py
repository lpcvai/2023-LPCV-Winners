...
class MobilenetV2_PIDNet(nn.Module):
    def __init__(self, num_classes=14, augment=True):
        ...
        # Remove last hard conv layer
        self.backbone.features[18][0] = nn.Identity()
        self.backbone.features[18][1] = nn.Identity()

        self.ppm = PAPPM(inplanes=320, branch_planes=96, outplanes=64)
